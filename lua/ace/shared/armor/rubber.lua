...
Material.resiliance	= 0.7 --Resiliance against penetrating kinetic shells
Material.Catchresiliance = 1.25 --Resiliance Multiplier used for kinetic shells when they fail to penetrate the armor and are "caught"
