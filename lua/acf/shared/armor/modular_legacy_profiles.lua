...
Profile("Rub", "Rubber", "Rubber", "Another material that while useless against kinetic rounds, excels at stopping shaped charges and spall", 1955, Rub, { "elastomer_liner", "spall_response", "shock_barrier" }, CommonSpec(Rub, { spallCapture = 0.65, spallCaptureArealDensity = 18, spallCaptureVelocity = 1400, spallCaptureSpacing = 0.1 }), { ductilityFactor = 1.25, ductilityBase = 2, ductilityScale = 1.5 })
