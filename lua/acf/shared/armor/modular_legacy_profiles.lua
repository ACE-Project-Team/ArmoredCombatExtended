...
Profile("Cer", "Ceramic", "Ceramic", "Ceramic is usually used as a material to ensure shells do not penetrate due to its high penetration resistance. Due to its frailty it is usually only used as a backing and is not meant to take the brunt of damage. Do not let it get penetrated or it will shatter.", 1955, Cer, { "brittle_strike_face", "spall_response", "failure_state" }, CommonSpec(Cer, { multiHitRetention = 0.2, degradation = 0.85 }), { impactHook = "ceramic_shatter", legacyResolver = "ceramic", ductilityFactor = 1.25, ductilityBase = 4, ductilityScale = 1.5 })
