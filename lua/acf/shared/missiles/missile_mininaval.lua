...
ACE_DefineGun("Scaled BGM-109 Tomahawk", {						-- id
...
ACE_DefineGun("Scaled AGM-84 Harpoon", {						-- id
	name             = "AGM-84 Harpoon",
...
ACE_DefineGun("Scaled Storm Shadow ASM", {						-- id
...
ACE_DefineGun("Scaled 3M-54 Kalibr", {						-- id
	name             = "3M-54 Kalibr",
...
ACE_DefineGun("Scaled Black Shark Torp", {						-- id
...
ACE_DefineGun("Scaled G7a Torp", {						-- id
...
ACE_DefineGun("Scaled Mk13 Torp", {						-- id
...
ACE_DefineGun("Scaled 9M317ME SAM", {							-- id
...
ACE_DefineGun("Scaled 5V55 SAM", {							-- id
	name             = "5V55 S-300 SAM",
