...
ACE_DefineGun("BGM-109 Tomahawk", {						-- id
...
ACE_DefineGun("AGM-84 Harpoon", {						-- id
	name             = "AGM-84 Harpoon",
...
ACE_DefineGun("Storm Shadow ASM", {						-- id
...
ACE_DefineGun("Black Shark Torp", {						-- id
