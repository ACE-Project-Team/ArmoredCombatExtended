...
ACE.AmmoBlacklist["FL"] = { "MG", "AC", "HMG", "SA", "RAC", "ATR", "SL", "GL", "FFAR", "FGL", "ATR", "SBC", "BOMB", "GBU", "ASM", "AAM", "SAM", "UAR", "POD", "FFAR", "ATGM", "ARTY" }


local Round = {}

Round.type  = "Ammo"								-- Tells the spawn menu what entity to spawn
Round.name  = "[FL] - " .. ACE.Translation.ShellFL[1]  -- Human readable name
Round.model = "models/munitions/dart_100mm.mdl"	-- Shell flight model
Round.desc  = ACE.Translation.ShellFL[2]
