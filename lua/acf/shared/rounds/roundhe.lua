...
ACE.AmmoBlacklist.HE = { "MG", "ECM","ATR","SBC" }

local Round = {}

Round.type  = "Ammo" --Tells the spawn menu what entity to spawn
Round.name  = "[HE] - " .. ACE.Translation.ShellHE[1] --Human readable name
...
function Round.guiupdate( Panel )
	...
	acemenupanel:AmmoSlider("FillerVol",Data.FillerVol,Data.MinFillerVol,Data.MaxFillerVol,3, "HE Filler Volume", "HE Filler Mass : " .. (math.floor(Data.FillerMass * 1000)) .. " g" .. "/ " .. (math.Round(Data.FillerMass, 1)) .. " kg")	--HE Filler Slider (Name, Min, Max, Decimals, Title, Desc)
