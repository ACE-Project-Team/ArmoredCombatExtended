...
ACE.KEPenLayerMul     = 0.8                     -- Remaining-energy multiplier applied every time solid shot penetrates a plate and continues. Layered steel underperforms one thick plate against solid shot (measured ~18-26% ballistic-limit loss for double layers), so stacked plates must not equal a monolithic one. 0.8 is a chosen energy-domain value near that band, not derived from it
